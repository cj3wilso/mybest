...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'max_file_size' => 'Image is too big, keep below 3MB',
        'min_file_size' => 'File is too small',
        'accept_file_types' => 'Filetype not allowed',
        'max_number_of_files' => 'Maximum number (30) of images exceeded',
        'max_width' => 'Image exceeds maximum width of 1920px',
        'min_width' => 'Image requires a minimum width of 390px',
        'max_height' => 'Image exceeds maximum height of 1200px',
        'min_height' => 'Image requires a minimum height of 390px'
    );

    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'database' => 'cj3wilso_rent254',  
			'host' => 'localhost',  
			'username' => 'cj3wilso_rent254',  
			'password' => '57575757aA',
	...
	{  
		$add_to_db = $this->query("INSERT INTO prop_photos (id_prop,photo) VALUES
			 ('".$_SESSION['prop']."','".$whichimg."')") or die(mysql_error());  
		return $add_to_db;  
	}
	
	function delete_img($delimg)  
	{  
		$delete_from_db = $this->query("DELETE FROM prop_photos WHERE photo = '$delimg'") or die(mysql_error());  
